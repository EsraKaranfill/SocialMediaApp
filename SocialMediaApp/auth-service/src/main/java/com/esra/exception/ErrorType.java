...
public enum ErrorType {
    ...
    ERROR_INVALID_LOGIN_PARAMETER(2002,"Kullanıcı adı ya da şifre hatalıdır. Lütfen düzelterek tekrar deneyiniz.",HttpStatus.BAD_REQUEST),
    ERROR_VERIFICATION_CODE(3000,"Aktisvasyon kodunu lütfen doğru giriniz.",HttpStatus.BAD_REQUEST)
    ;
